...
func (c *Client) ReadRequest() *Reply {
	c.setReadTimeout()
	return c.parse()
}

func (c *Client) WriteRespone(rp interface{}) error {
	err := resp.WriteArbitraryAsString(c.Conn, rp)
	if err != nil {
		c.Close()
		return err
	}
...
func Parse(reader *bytes.Buffer) *Reply {
